...
class Priority:
    ...
    def processData(self, no_of_processes):
        ...
        for i in range(no_of_processes):
            ...
            arrival_time = int(input(f"Enter Arrival Time for Process ID{process_id}: "))
            burst_time = int(input(f"Enter Burst Time for Process ID{process_id}: "))
            priority = int(input(f"Enter Priority for Process ID{process_id}: "))
